...
# ========== USER CONFIG ==========
MASK_DIR = r"C:\Users\Safinaz's Laptop\heart_vis\masks_heart"   # <--- set if different
...
# ---------- Save mesh automatically ----------
out_mesh = os.path.join(OUT_DIR, "heart_model_clean.stl")
mesh.save(out_mesh)
...
plotter.add_text("Key: 'e' to view cleaned PNG path",
...
print("Mesh STL automatically saved.")
