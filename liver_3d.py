...
# ========== USER CONFIG ==========
MASK_DIR = r"C:\Users\Safinaz's Laptop\heart_vis\masks_liver"   # <--- set if different
...
mesh = mesh.fill_holes(100.0)                        # fill holes (tune value)
mesh = mesh.smooth(n_iter=30, relaxation_factor=0.1)  # smooth surface
# optional: simplify (keep ~50%)
...
def save_mesh():
    out_mesh = os.path.join(OUT_DIR, "Liver_model_clean.stl")
    mesh.save(out_mesh)
